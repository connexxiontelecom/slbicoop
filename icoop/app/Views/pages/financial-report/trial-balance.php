...
//$_opcr = $opcr + $equity['period']['pbcr'];
                    ...
                    <tr>
                        ...
                        <td style="text-align: right"> <b><?=number_format($total_opdr, 2); ?></b> </td>
                        <td style="text-align: right"> <b><?=number_format($total_opcr, 2); ?></b> </td>
                        <td style="text-align: right"> <b><?=number_format($total_pbdr, 2); ?></b> </td>
                        <td style="text-align: right"> <b><?=number_format($total_pbcr, 2); ?></b> </td>
                        <td style="text-align: right"> <b><?=number_format($_total_opdr, 2); ?></b> </td>
                        <td style="text-align: right"> <b><?=number_format($_total_opcr, 2); ?></b> </td>
                    </tr>
